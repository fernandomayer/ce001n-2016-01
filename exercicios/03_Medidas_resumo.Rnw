...
<<siso, echo=FALSE, out.width=".5\\textwidth", pdfcrop=TRUE, fig.width=6,fig.height=5,include=TRUE>>=
set.seed(100)
...
## Média ---------------------------------------------------------------
(mex202 <- sum(pm2 * fri))
## A média é multiplicada por 2
## Variância -----------------------------------------------------------
(vex202 <- sum(pm2^2 * fri) - sum(pm2 * fri)^2)
## A variância é multiplicada por 4
@
...
## Média ---------------------------------------------------------------
(mex203 <- sum(pm3 * fri))
## A média aumenta em duas unidades
## Mediana -------------------------------------------------------------
pm3[2]
## A mediana aumenta em duas unidades
## Variância -----------------------------------------------------------
